...
[ 1 ] ; _rtB -> B_5_0_0 [ 2 ] = _rtX -> Integrator1_CSTATE [ 2 ] ;
ssCallAccelRunBlock ( S , 5 , 1 , SS_CALL_MDL_OUTPUTS ) ; _rtB -> B_5_2_0 =
ssGetT ( S ) ; ssCallAccelRunBlock ( S , 4 , 0 , SS_CALL_MDL_OUTPUTS ) ; _rtB
-> B_5_4_0 [ 0 ] = _rtB -> B_5_0_0 [ 0 ] - _rtB -> B_4_0_1 [ 0 ] ; _rtB ->
B_5_4_0 [ 1 ] = _rtB -> B_5_0_0 [ 1 ] - _rtB -> B_4_0_1 [ 1 ] ; _rtB ->
B_5_4_0 [ 2 ] = _rtB -> B_5_0_0 [ 2 ] - _rtB -> B_4_0_1 [ 2 ] ;
ssCallAccelRunBlock ( S , 5 , 5 , SS_CALL_MDL_OUTPUTS ) ; _rtB -> B_5_6_0 [ 0
] = _rtP -> P_2 * _rtB -> B_5_4_0 [ 0 ] ; _rtB -> B_5_7_0 [ 0 ] = _rtX ->
Integrator_CSTATE [ 0 ] ; _rtB -> B_5_8_0 [ 0 ] = _rtP -> P_4 * _rtB ->
B_5_7_0 [ 0 ] ; _rtB -> B_5_6_0 [ 1 ] = _rtP -> P_2 * _rtB -> B_5_4_0 [ 1 ] ;
_rtB -> B_5_7_0 [ 1 ] = _rtX -> Integrator_CSTATE [ 1 ] ; _rtB -> B_5_8_0 [ 1
] = _rtP -> P_4 * _rtB -> B_5_7_0 [ 1 ] ; _rtB -> B_5_6_0 [ 2 ] = _rtP -> P_2
* _rtB -> B_5_4_0 [ 2 ] ; _rtB -> B_5_7_0 [ 2 ] = _rtX -> Integrator_CSTATE [
2 ] ; _rtB -> B_5_8_0 [ 2 ] = _rtP -> P_4 * _rtB -> B_5_7_0 [ 2 ] ; if ( (
_rtDW -> TimeStampA >= ssGetT ( S ) ) && ( _rtDW -> TimeStampB >= ssGetT ( S
) ) ) { _rtB -> B_5_9_0 [ 0 ] = 0.0 ; _rtB -> B_5_9_0 [ 1 ] = 0.0 ; _rtB ->
B_5_9_0 [ 2 ] = 0.0 ; } else { lastTime = _rtDW -> TimeStampA ; lastU = &
...
ssGetT ( S ) ) { lastTime = _rtDW -> TimeStampB ; lastU = & _rtDW ->
LastUAtTimeB ; } } lastTime = ssGetT ( S ) - lastTime ; _rtB -> B_5_9_0 [ 0 ]
= ( _rtB -> B_5_4_0 [ 0 ] - ( * lastU ) [ 0 ] ) / lastTime ; _rtB -> B_5_9_0
[ 1 ] = ( _rtB -> B_5_4_0 [ 1 ] - ( * lastU ) [ 1 ] ) / lastTime ; _rtB ->
B_5_9_0 [ 2 ] = ( _rtB -> B_5_4_0 [ 2 ] - ( * lastU ) [ 2 ] ) / lastTime ; }
_rtB -> B_5_10_0 [ 0 ] = _rtP -> P_5 * _rtB -> B_5_9_0 [ 0 ] ; _rtB ->
B_5_11_0 [ 0 ] = ( _rtB -> B_5_6_0 [ 0 ] + _rtB -> B_5_8_0 [ 0 ] ) + _rtB ->
B_5_10_0 [ 0 ] ; _rtB -> B_5_12_0 [ 0 ] = _rtX -> Integrator_CSTATE_m [ 0 ] ;
_rtB -> B_5_10_0 [ 1 ] = _rtP -> P_5 * _rtB -> B_5_9_0 [ 1 ] ; _rtB ->
B_5_11_0 [ 1 ] = ( _rtB -> B_5_6_0 [ 1 ] + _rtB -> B_5_8_0 [ 1 ] ) + _rtB ->
B_5_10_0 [ 1 ] ; _rtB -> B_5_12_0 [ 1 ] = _rtX -> Integrator_CSTATE_m [ 1 ] ;
_rtB -> B_5_10_0 [ 2 ] = _rtP -> P_5 * _rtB -> B_5_9_0 [ 2 ] ; _rtB ->
B_5_11_0 [ 2 ] = ( _rtB -> B_5_6_0 [ 2 ] + _rtB -> B_5_8_0 [ 2 ] ) + _rtB ->
B_5_10_0 [ 2 ] ; _rtB -> B_5_12_0 [ 2 ] = _rtX -> Integrator_CSTATE_m [ 2 ] ;
if ( ( _rtDW -> TimeStampA_m >= ssGetT ( S ) ) && ( _rtDW -> TimeStampB_o >=
ssGetT ( S ) ) ) { _rtB -> B_5_13_0 [ 0 ] = 0.0 ; _rtB -> B_5_13_0 [ 1 ] =
0.0 ; _rtB -> B_5_13_0 [ 2 ] = 0.0 ; } else { lastTime = _rtDW ->
TimeStampA_m ; lastU = & _rtDW -> LastUAtTimeA_e ; if ( _rtDW -> TimeStampA_m
< _rtDW -> TimeStampB_o ) { if ( _rtDW -> TimeStampB_o < ssGetT ( S ) ) {
lastTime = _rtDW -> TimeStampB_o ; lastU = & _rtDW -> LastUAtTimeB_e ; } }
else { if ( _rtDW -> TimeStampA_m >= ssGetT ( S ) ) { lastTime = _rtDW ->
TimeStampB_o ; lastU = & _rtDW -> LastUAtTimeB_e ; } } lastTime = ssGetT ( S
) - lastTime ; _rtB -> B_5_13_0 [ 0 ] = ( _rtB -> B_4_0_1 [ 0 ] - ( * lastU )
[ 0 ] ) / lastTime ; _rtB -> B_5_13_0 [ 1 ] = ( _rtB -> B_4_0_1 [ 1 ] - ( *
lastU ) [ 1 ] ) / lastTime ; _rtB -> B_5_13_0 [ 2 ] = ( _rtB -> B_4_0_1 [ 2 ]
- ( * lastU ) [ 2 ] ) / lastTime ; } if ( ( _rtDW -> TimeStampA_l >= ssGetT (
S ) ) && ( _rtDW -> TimeStampB_n >= ssGetT ( S ) ) ) { _rtB -> B_5_14_0 [ 0 ]
= 0.0 ; _rtB -> B_5_14_0 [ 1 ] = 0.0 ; _rtB -> B_5_14_0 [ 2 ] = 0.0 ; } else
{ lastTime = _rtDW -> TimeStampA_l ; lastU = & _rtDW -> LastUAtTimeA_b ; if (
_rtDW -> TimeStampA_l < _rtDW -> TimeStampB_n ) { if ( _rtDW -> TimeStampB_n
< ssGetT ( S ) ) { lastTime = _rtDW -> TimeStampB_n ; lastU = & _rtDW ->
LastUAtTimeB_j ; } } else { if ( _rtDW -> TimeStampA_l >= ssGetT ( S ) ) {
lastTime = _rtDW -> TimeStampB_n ; lastU = & _rtDW -> LastUAtTimeB_j ; } }
lastTime = ssGetT ( S ) - lastTime ; _rtB -> B_5_14_0 [ 0 ] = ( _rtB ->
B_5_13_0 [ 0 ] - ( * lastU ) [ 0 ] ) / lastTime ; _rtB -> B_5_14_0 [ 1 ] = (
_rtB -> B_5_13_0 [ 1 ] - ( * lastU ) [ 1 ] ) / lastTime ; _rtB -> B_5_14_0 [
2 ] = ( _rtB -> B_5_13_0 [ 2 ] - ( * lastU ) [ 2 ] ) / lastTime ; } _rtB ->
B_5_15_0 = _rtX -> Integrator_CSTATE_p ; if ( ( _rtDW -> IC_FirstOutputTime
== ( rtMinusInf ) ) || ( _rtDW -> IC_FirstOutputTime == ssGetTaskTime ( S , 0
) ) ) { _rtDW -> IC_FirstOutputTime = ssGetTaskTime ( S , 0 ) ; _rtB ->
B_5_16_0 = _rtP -> P_8 ; } else { _rtB -> B_5_16_0 = _rtB -> B_5_15_0 ; } if
( _rtB -> B_5_1_0 > _rtP -> P_9 ) { _rtB -> B_5_17_0 = _rtB -> B_5_0_0_m ; }
else { _rtB -> B_5_17_0 = _rtB -> B_5_16_0 ; } { real_T * * uBuffer = (
real_T * * ) & _rtDW -> TransportDelay_PWORK . TUbufferPtrs [ 0 ] ; real_T *
* tBuffer = ( real_T * * ) & _rtDW -> TransportDelay_PWORK . TUbufferPtrs [ 4
] ; real_T simTime = ssGetT ( S ) ; real_T tMinusDelay ; { int_T i1 ; real_T
* y0 = & _rtB -> B_5_18_0 [ 0 ] ; const real_T * p_P_11 = _rtP -> P_11 ;
...
_rtDW -> TransportDelay_IWORK . CircularBufSize [ 0 ] ; for ( i1 = 0 ; i1 < 4
; i1 ++ ) { tMinusDelay = ( ( _rtP -> P_10 > 0.0 ) ? _rtP -> P_10 : 0.0 ) ;
...
] , p_P_11 [ i1 ] , 0 , ( boolean_T ) ( ssIsMinorTimeStep ( S ) && (
ssGetTimeOfLastOutput ( S ) == ssGetT ( S ) ) ) ) ; tBuffer ++ ; uBuffer ++ ;
} } } if ( ( _rtDW -> IC_FirstOutputTime_k == ( rtMinusInf ) ) || ( _rtDW ->
IC_FirstOutputTime_k == ssGetTaskTime ( S , 0 ) ) ) { _rtDW ->
IC_FirstOutputTime_k = ssGetTaskTime ( S , 0 ) ; _rtB -> B_5_19_0 [ 0 ] =
_rtP -> P_12 [ 0 ] ; _rtB -> B_5_19_0 [ 1 ] = _rtP -> P_12 [ 1 ] ; _rtB ->
B_5_19_0 [ 2 ] = _rtP -> P_12 [ 2 ] ; } else { _rtB -> B_5_19_0 [ 0 ] = _rtB
-> B_5_0_0 [ 0 ] ; _rtB -> B_5_19_0 [ 1 ] = _rtB -> B_5_0_0 [ 1 ] ; _rtB ->
B_5_19_0 [ 2 ] = _rtB -> B_5_0_0 [ 2 ] ; } ssCallAccelRunBlock ( S , 5 ,
...
_rtB -> B_5_0_0_m = _rtP -> P_19 ; _rtB -> B_5_1_0 = _rtP -> P_20 ;
...
* lastU ) [ 0 ] = _rtB -> B_5_4_0 [ 0 ] ; ( * lastU ) [ 1 ] = _rtB -> B_5_4_0
[ 1 ] ; ( * lastU ) [ 2 ] = _rtB -> B_5_4_0 [ 2 ] ; if ( _rtDW ->
...
_rtDW -> TimeStampB_n = ssGetT ( S ) ; lastU = & _rtDW -> LastUAtTimeB_j ; }
( * lastU ) [ 0 ] = _rtB -> B_5_13_0 [ 0 ] ; ( * lastU ) [ 1 ] = _rtB ->
B_5_13_0 [ 1 ] ; ( * lastU ) [ 2 ] = _rtB -> B_5_13_0 [ 2 ] ; { real_T * *
...
0 ] , & _rtDW -> TransportDelay_IWORK . Last [ 0 ] , simTime - _rtP -> P_10 ,
...
1 ] , & _rtDW -> TransportDelay_IWORK . Last [ 1 ] , simTime - _rtP -> P_10 ,
tBuffer , uBuffer , ( NULL ) , ( boolean_T ) 0 , false , & _rtDW ->
TransportDelay_IWORK . MaxNewBufSize ) ) { ssSetErrorStatus ( S ,
"tdelay memory allocation error" ) ; return ; } } ( * tBuffer ++ ) [ _rtDW ->
...
2 ] , & _rtDW -> TransportDelay_IWORK . Last [ 2 ] , simTime - _rtP -> P_10 ,
tBuffer , uBuffer , ( NULL ) , ( boolean_T ) 0 , false , & _rtDW ->
TransportDelay_IWORK . MaxNewBufSize ) ) { ssSetErrorStatus ( S ,
"tdelay memory allocation error" ) ; return ; } } ( * tBuffer ++ ) [ _rtDW ->
...
3 ] , & _rtDW -> TransportDelay_IWORK . Last [ 3 ] , simTime - _rtP -> P_10 ,
tBuffer , uBuffer , ( NULL ) , ( boolean_T ) 0 , false , & _rtDW ->
TransportDelay_IWORK . MaxNewBufSize ) ) { ssSetErrorStatus ( S ,
"tdelay memory allocation error" ) ; return ; } } ( * tBuffer ) [ _rtDW ->
...
B_5_12_0 [ 0 ] ; _rtXdot -> Integrator_CSTATE [ 0 ] = _rtB -> B_5_4_0 [ 0 ] ;
_rtXdot -> Integrator_CSTATE_m [ 0 ] = _rtB -> B_0_0_5 [ 0 ] ; _rtXdot ->
Integrator1_CSTATE [ 1 ] = _rtB -> B_5_12_0 [ 1 ] ; _rtXdot ->
Integrator_CSTATE [ 1 ] = _rtB -> B_5_4_0 [ 1 ] ; _rtXdot ->
Integrator_CSTATE_m [ 1 ] = _rtB -> B_0_0_5 [ 1 ] ; _rtXdot ->
Integrator1_CSTATE [ 2 ] = _rtB -> B_5_12_0 [ 2 ] ; _rtXdot ->
Integrator_CSTATE [ 2 ] = _rtB -> B_5_4_0 [ 2 ] ; _rtXdot ->
Integrator_CSTATE_m [ 2 ] = _rtB -> B_0_0_5 [ 2 ] ; _rtXdot ->
Integrator_CSTATE_p = _rtB -> B_2_0_1 ; } static void mdlInitializeSizes (
SimStruct * S ) { ssSetChecksumVal ( S , 0 , 3102002498U ) ; ssSetChecksumVal
( S , 1 , 151183797U ) ; ssSetChecksumVal ( S , 2 , 357376243U ) ;
ssSetChecksumVal ( S , 3 , 2166810466U ) ; { mxArray * slVerStructMat = NULL
